...
public class ResourceUsageItemProvider extends ProcessElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUsage_needed_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUsage_needed_feature", "_UI_ResourceUsage_type"),
				 SimplepdlPackage.Literals.RESOURCE_USAGE__NEEDED,
				 true,
				 false,
				 false,
	...
	protected void addRessourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ResourceUsage_ressource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ResourceUsage_ressource_feature", "_UI_ResourceUsage_type"),
				 SimplepdlPackage.Literals.RESOURCE_USAGE__RESSOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(Object object) {
		...
		return getString("_UI_ResourceUsage_type") + " " + resourceUsage.getNeeded();
	}
