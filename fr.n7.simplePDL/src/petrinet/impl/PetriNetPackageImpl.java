...
public class PetriNetPackageImpl extends EPackageImpl implements PetriNetPackage {
	...
	public void createPackageContents() {
		...
		createEReference(petriNetEClass, PETRI_NET__PETRIELEMENT);
	...
	public void initializePackageContents() {
		...
		initEReference(getPetriNet_Petrielement(), this.getPetriElement(), null, "petrielement", null, 0, -1, PetriNet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getArc_Kind(), this.getArcKind(), "kind", null, 0, 1, Arc.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
