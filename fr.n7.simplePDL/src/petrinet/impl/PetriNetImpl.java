 ...
 *   <li>{@link petrinet.impl.PetriNetImpl#getPetrielement <em>Petrielement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PetriNetImpl extends MinimalEObjectImpl.Container implements PetriNet {
	...
	public EList<PetriElement> getPetrielement() {
		if (petrielement == null) {
			petrielement = new EObjectContainmentEList<PetriElement>(PetriElement.class, this, PetriNetPackage.PETRI_NET__PETRIELEMENT);
		}
		return petrielement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PetriNetPackage.PETRI_NET__PETRIELEMENT:
