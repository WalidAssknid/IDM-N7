 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getResourceusage <em>Resourceusage</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	public EList<ResourceUsage> getResourceusage() {
		if (resourceusage == null) {
			resourceusage = new EObjectContainmentEList<ResourceUsage>(ResourceUsage.class, this, SimplepdlPackage.WORK_DEFINITION__RESOURCEUSAGE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__RESOURCEUSAGE:
