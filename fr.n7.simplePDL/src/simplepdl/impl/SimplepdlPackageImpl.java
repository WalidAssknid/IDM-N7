...
public class SimplepdlPackageImpl extends EPackageImpl implements SimplepdlPackage {
	 ...
	 */
	@Override
	public EReference getWorkDefinition_Resourceusage() {
	 ...
	 */
	@Override
	public EReference getResourceUsage_Ressource() {
	...
	public void createPackageContents() {
		...
		createEReference(workDefinitionEClass, WORK_DEFINITION__RESOURCEUSAGE);
		...
		createEReference(resourceUsageEClass, RESOURCE_USAGE__RESSOURCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getWorkDefinition_Resourceusage(), this.getResourceUsage(), null, "resourceusage", null, 0, -1, WorkDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getResourceUsage_Ressource(), this.getRessource(), null, "ressource", null, 1, 1, ResourceUsage.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
