...
public interface SimplepdlPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__RESOURCEUSAGE = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESOURCE_USAGE__NEEDED = PROCESS_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESOURCE_USAGE__RESSOURCE = PROCESS_ELEMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int RESOURCE_USAGE_FEATURE_COUNT = PROCESS_ELEMENT_FEATURE_COUNT + 2;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getResourceusage <em>Resourceusage</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Resourceusage</em>'.
	 * @see simplepdl.WorkDefinition#getResourceusage()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_Resourceusage();
	...
	/**
	 * Returns the meta object for the attribute '{@link simplepdl.ResourceUsage#getNeeded <em>Needed</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Needed</em>'.
	 * @see simplepdl.ResourceUsage#getNeeded()
	...
	/**
	 * Returns the meta object for the reference '{@link simplepdl.ResourceUsage#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource</em>'.
	 * @see simplepdl.ResourceUsage#getRessource()
	 * @see #getResourceUsage()
	 * @generated
	 */
	EReference getResourceUsage_Ressource();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference WORK_DEFINITION__RESOURCEUSAGE = eINSTANCE.getWorkDefinition_Resourceusage();
		 ...
		 * @generated
		 */
		EReference RESOURCE_USAGE__RESSOURCE = eINSTANCE.getResourceUsage_Ressource();
